...
[ "$#" -ne 5 ] && failure $EXIT_INVALID_ARGS "Usage: $script_name <id> <zip_filename> <path> <data_type> <output_dir>"
...
echo "$json_payload" > "$message_file" && log "Created message file: $message_file" || failure $EXIT_FILE_CREATION_FAIL "Failed to write to message file: $message_file"
